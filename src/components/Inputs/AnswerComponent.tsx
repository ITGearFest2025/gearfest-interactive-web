...
const AnswerComponent = ({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center">
      <div
        className={`w-[334px] bg-gradient-to-b ${theme === "light" ? "from-[#c6985f] to-[#a05646]" : "from-[#1a1635] to-[#1a1622]"} px-3 py-4`}
      >
        <div
          className={`border-[3px] ${theme === "light" ? "border-[#ffecc7]" : "border-[#d2cea0]"} p-1.5`}
        >
          <div
            className={`font-mitr space-y-4 border-[1.5px] ${theme === "light" ? "border-[#ffecc7]" : "border-[#d2cea0]"} px-6 py-6`}
          >
